jQuery(function ($) {
	$.fn.quicksearch = function (opt) {
		...
		function make_form_input()
		{
			...
			return '<input type="text" autofocus x-webkit-speech placeholder="Number or place" type="search" value="' + val + '" rel="' + options.randomElement  + '" class="' + options.inputClass + '" id="' + options.randomElement + '" /> ';
		}
